...
\begin{figure}[htbp]
  \centering
  \subfloat[Single-Event Upset (SEU) \cite{IROC2013} \label{fig:Soft_SEU}]{\includegraphics[width=0.45\textwidth]{Imagenes/SEU/SEU.eps}} \qquad
  \subfloat[Single-Event Transient (SET) \cite{IROC2013} \label{fig:Soft_SET}]{\includegraphics[width=0.45\textwidth]{Imagenes/SEU/SET.eps}}
