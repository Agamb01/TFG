...
Los microprocesadores, como todos los sistemas, son susceptibles de sufrir fallos y producir errores a varios niveles (se explican en el capítulo \ref{fallos}), errores que provocan comportamientos erráticos y no deseados. 
...
\begin{description}
  ...
  \item Capitulo \ref{procesador} \textit{Introducción al procesador}:
	...
	En el capitulo \ref{analisis} se analizan los datos expuestos en el capítulo anterior.
