...
\chapter{Conclusions} % y futuras líneas de trabajo}
\label{conclusions}
...
%Se ha diseñado una Unidad Central de Proceso (CPU) segmentada en 5 etapas, capaz de ejecutar un conjunto reducido de instrucciones conocido como THUMB-2, concretamente es un subconjunto de instrucciones de la arquitectura ARM. Esta CPU ejecuta correctamente instrucciones aritmético-lógicas, instrucciones de acceso a memoria e instrucciones de bifurcación o salto.
A Central Processing Unit (CPU) has been developed. This CPU has a 5 stage pipeline and is capable of executing a reduce instruction set knwon as THUMB-2, this is a sub-set of ARM architecture instruction set. This CPU correctly executes arithmetic and logic instructions, memory access instructions and branch instructions.
...
Once the microprocessor was capable of running simple programs, it's dependecy level was enhanced by applying fault tolerance techniques, specifically the "`Triple Modular Redundancy"' (TMR) technique. The pipeline registers have been tripled and majority voters have been inserted to obtain the correct values.
