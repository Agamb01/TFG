...
La tolerancia se trata principalmente aplicando la redundancia en uno o varios de los siguientes campos:

\begin{itemize}
  \item \textbf{Redundancia de Información:} Se mantienen varias copias de los datos.
  \item \textbf{Redundancia de Recursos:} Se replican varias veces los componentes funcionales.
	\item \textbf{Redundancia de Tiempo:} Se realiza una acción varias veces.
\end{itemize}
