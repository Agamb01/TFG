...
Además de las ventajas vistas en el apartado anterior, la segmentación también implica unos riesgos a la hora de ejecutar las instrucciones. Estos riesgos pueden ser de los siguientes tipos[\cite{Hennessy1993}]: % Arquitectura de Computadores: Un enfoque cuantitativo

\begin{enumerate}
  \item \textit{Riesgos estructurales}. Surgen cuando 2 o más instrucciones necesitan acceder a los mismos recursos.
	\item \textit{Riesgos de datos}. Surgen cuando una instrucción depende del resultado de una instrucción anterior, y esta todavía no lo ha escrito en el registro correspondiente.
...
Se dividen en tres tipos según su formato (figura \ref{fig:instrucciones_dlx}):

\begin{itemize}
  \item \textit{Tipo R}. Instrucciones sobre dos registros.
	\item \textit{Tipo I}. Instrucciones sobre un registro y un inmediato.
	\item \textit{Tipo J}. Instrucciones de salto.
\end{itemize}

\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.75\textwidth]{Imagenes/Instrucciones/dlx.eps}
...
Como pudimos ver en la figura \ref{tab:segmentacion}, las instrucciones se buscan en cada ciclo de reloj.
