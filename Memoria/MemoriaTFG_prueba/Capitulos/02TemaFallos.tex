...
El sistema sufre las consecuencias como un cambio de valor en un bit. En un microprocesador el bit afectado es una celda de memoria en un registro corromperá el dato almacenado. Si afecta a un biestable en cualquier etapa de la segmentación, puede alterar el comportamiento de la instrucción, siendo más o menos grave según el lugar donde se produzca el fallo.
