...
\subsection*{Origen}
%-------------------------------------------------------------------
\label{cap2:fallos:origen}

La causa de estos fallos se conoce como \textit{Single-Event Effects (SEEs)}, y se deben al choque de una partícula de energía contra un elemento del circuito integrado.

Todos los elementos de un circuitos integrados menores a un milímetro son susceptibles a los SEE. Si la partícula colisiona contra o cerca de un transistor, y esta tiene suficiente energía, inducirá un cambio de valor en el mismo, esto se conoce como Single-Event Upset (SEU). Si la partícula colisiona contra una conexión, puede inducir corriente y voltaje que puede propagarse por el circuito.

El origen de partículas puede venir del espacio, de núcleos de átomos que viajan a casi a la velocidad de la luz y chocan contra la tierra desde todas las direcciones, llamados rayos cósmicos. 
...
Además la presión del aire también participa en la generación de estas partículas y su transporte hasta el nivel de suelo. [\cite{Hu2010}]
...
%-------------------------------------------------------------------
\label{cap2:fallos:transitorios}

Los \textbf{fallos transitorios}, también llamados \textit{soft errors}, [\cite{Actel2002}].

SET: Son fallos que afectan a las conexiones del chip. 

SEU: Son fallos que alteran la carga almacenada en un transistor.
