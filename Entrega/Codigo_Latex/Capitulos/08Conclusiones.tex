...
Estas tareas que acaban de comentarse, son los objetivos del proyecto. Todos ellos se han llevado a cabo satisfactoriamente.

Gracias a que la CPU es capaz de ejecutar instrucciones THUMB-2, con algunas restricciones podría ejecutar código compilado por compiladores ARM ya existente. Por su simpleza se puede integrar en sistemas empotrados que requieran minimizar los recursos utilizados. Y gracias a la TMR aplicada es una opción para aplicaciones en las que puedan sufrir fallos.

Como trabajo futuro se plantea añadir tolerancia a otros tipos de fallos no considerados en este proyecto para obtener una CPU más robusta, y realizar un sistema multi-core utilizando esta CPU como base para aumentar el rendimiento del sistema.
