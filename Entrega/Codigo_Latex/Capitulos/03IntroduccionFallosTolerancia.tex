...
%
%\begin{resumen}
%En este capítulo se define qué es un fallo y qué tipos de fallos pueden ocurrir en los sistemas electrónicos. Además se introducen algunas técnicas de tolerancia a fallos y ejemplos de procesadores tolerantes a fallos.
%\end{resumen}
...
Entre otros casos podemos destacar el choque de una partícula de energía contra un elemento del circuito integrado. Figura	\ref{fig:SEU_FPGA}. En general, los fallos se conocen como \textit{"`Single-Event Effects (SEEs)"'}. 

\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.80\textwidth]{Imagenes/Capitulo3/SEU_FPGA.jpg}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.75\textwidth]{Imagenes/Capitulo1/Neutrones1.eps}
	\caption{Flujo de neutrones a 40.000 pies de altitud \cite{Hu2010}.} 
	\label{fig:errores_vs_altitud2}
\end{figure}

Como ya se adelantó en la introducción, los efectos varían según la latitud, la longitud y la altitud. Figura \ref{fig:errores_vs_altitud2}. Al entrar en contacto con la atmósfera las partículas colisionan contra estas y pierden energía. Cuanto menor sea la densidad, mayor será el número de partículas que llega al nivel del suelo manteniendo su energía, mayor será el numero de partículas que puedan colisionar contra un chip y en consecuencia mayor la probabilidad que se produzca un fallo. Para más información sobre lluvias de partículas véase el trabajo de W.K. Melis\cite{Melis2014}.
...
\begin{itemize}
  ...
  \item \textbf{Single-Event Functional Interrupt (SEFI)}
	...
	Fallos que producen una perdida temporal de la funcionalidad del dispositivo, provocando un mal funcionamiento detectable, que no requiere reiniciar el sistema para recuperar su funcionalidad. Normalmente se asocia con un SEU en los registros de control.
...
\begin{figure}[htbp]
  \centering
  \subfloat[Single-Event Upset (SEU) \cite{IROC2013} \label{fig:Soft_SEU}]{\includegraphics[width=0.45\textwidth]{Imagenes/Capitulo3/SEU.eps}} \qquad
  \subfloat[Single-Event Transient (SET) \cite{IROC2013} \label{fig:Soft_SET}]{\includegraphics[width=0.45\textwidth]{Imagenes/Capitulo3/SET.eps}}
...
\begin{itemize}
  ...
  \item \textbf{Enmascarado lógico}
	...
	\begin{figure}[htbp]
		\centering
			\includegraphics[width=0.75\textwidth]{Imagenes/Capitulo3/Logical_masking.jpg}
		\caption{Fallo enmascarado por una puerta lógica\cite{Kastensmidt}.}
	...
	\begin{figure}[htbp]
		\centering
			\includegraphics[width=0.75\textwidth]{Imagenes/Capitulo3/Electrical_masking.jpg}
		\caption{Fallo enmascarado eléctricamente\cite{Kastensmidt}.}
	...
	\begin{figure}[htbp]
		\centering
			\includegraphics[width=0.75\textwidth]{Imagenes/Capitulo3/Latching_masking.jpg}
		\caption{Fallo enmascarado por ventana de tiempo\cite{Kastensmidt}.}
...
\begin{figure}[htbp]
  \centering
  \subfloat[Módulo original]{\includegraphics[width=0.45\textwidth]{Imagenes/Capitulo3/No_NMR.eps}} \qquad
  \subfloat[Módulo con TMR]{\includegraphics[width=0.45\textwidth]{Imagenes/Capitulo3/NMR.eps}}
