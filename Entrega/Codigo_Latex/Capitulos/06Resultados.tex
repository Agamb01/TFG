...
%-------------------------------------------------------------------
\section{Validación del procesador estándar}
%-------------------------------------------------------------------
...
\subsubsection{Map report}
		...
		\lstset{captionpos=b,breaklines=true, basicstyle=\footnotesize}
  \begin{lstlisting}[frame=single,caption={Recursos utilizados por el procesador estándar},label=lis:mapproc]
Design Summary
--------------
Number of errors:      0
...
Slice Logic Distribution:
 ...
 \end{lstlisting}
	...
	%\caption{Informe de recursos utilizados por el procesador estándar.}
	%\label{inf:recursosproc}
%\end{figure}
...
\subsubsection{Timing report}
  ...
  \begin{lstlisting}[frame=single,caption={Restricciones de tiempo del procesador estándar},label=lis:timingproc]
Timing summary:
---------------
...
\lstset{breaklines=true, basicstyle=\footnotesize, numbers=left}
  \begin{lstlisting}[frame=single,caption={Errores detectados tras la inserción de fallos.},label=lis:errorproc]
...
%-------------------------------------------------------------------
\section{Validación del procesador tolerante a fallos}
%-------------------------------------------------------------------
...
\subsubsection{Map report}
  \lstset{breaklines=true, basicstyle=\footnotesize}
  \begin{lstlisting}[frame=single,caption={Recursos utilizados por el procesador tolerante a fallos},label=lis:mapproctf]
Design Summary
--------------
Number of errors:      0
...
\subsubsection{Timing report}
  \lstset{breaklines=true, basicstyle=\footnotesize}
  \begin{lstlisting}[frame=single,caption={Restricciones de tiempo del procesador tolerante a fallos},label=lis:timingproctf]
Timing summary:
---------------
