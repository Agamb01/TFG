...
\chapter{Arquitectura de un procesador}
\label{procesador}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.50\textwidth]{Imagenes/Capitulo2/CPU.eps}
	\caption{Procesador}
	\label{fig:cpu}
\end{figure}
...
\begin{enumerate}
  ...
  \item Realizar accesos a memoria.
  \item Almacenar los resultados en el banco de registros.
\end{enumerate}
...
\begin{figure}[htbp]
  \centering
  \subfloat{\includegraphics[width=0.45\textwidth]{Imagenes/Capitulo2/VonNeumann.eps}} 
	  \hspace{5mm}
  \subfloat{\includegraphics[width=0.45\textwidth]{Imagenes/Capitulo2/Harvard.eps}}
...
\begin{figure}[htpb]
	\centering
		\includegraphics[width=\textwidth]{Imagenes/Capitulo2/SecuencialVSSegmentado.eps}
	...
	\item \textit{Riesgos de datos}. Surgen cuando la ejecución de una instrucción depende del resultado de una instrucción anterior, y este todavía no se ha escrito en el registro correspondiente. A su vez pueden ser:
	  ...
	  \begin{itemize}
		  \item \textsl{Lectura después de escritura (RAW)}. Una instrucción intenta leer un dato antes de que se escriba en el registro.
			...
			\item \textsl{Lectura después de lectura (RAR)}. \textbf{No} es un riesgo ya que no se modifican datos.
	  \end{itemize}
...
\begin{figure}
	\centering
		\includegraphics[width=0.50\textwidth]{Imagenes/Capitulo2/snapdragon-processors-810.png}
	\caption{Procesador Qualcomm Snapdragon 810. \cite{Mobile}}
	\label{fig:snapdragon-processors-810}
\end{figure}

Además de requerir poco espacio, los diseños de la arquitectura ARM consiguen minimizar el consumo de energía, haciéndolo apropiado para sistemas móviles empotrados\footnote{Sistema de computación diseñado para realizar una o pocas funciones dedicadas.} que dependen de una batería. 
...
\begin{itemize}
  ...
  Otra instrucción de salto permite almacenar el valor del contador de programa en un registro para poder volver al mismo punto al finalizar el desvío. Esto es útil cuando se quiere llamar a una subrutina.
	...
	También es posible lanzar instrucciones de salto que realizan un cambio de juego de instrucciones, en caso de necesitar lanzar subrutinas en alguno de los otros juegos de instrucciones compatibles con la arquitectura, tal es el caso de Thumb\footnote{Conjunto de instrucciones de 16 bits utilizado para reducir el tamaño del código.} o Jazelle\footnote{Repertorio de instrucciones de tipo "`bytecode Java"'.}.
...
Los procesadores ARM son capaces de procesar instrucciones de tres repertorios diferentes. El repertorio ARM \cite{ARM-InstructionSet}, el set Thumb/Thumb-2\footnote{Extensión de Thumb con instrucciones de 32 bits.} \cite{R.B.J.BrinkgreveW.M.Swolfs2011} y las instrucciones Jazelle \cite{ARM-InstructionSet}.
...
\begin{figure}[h]
	\centering
		\includegraphics[width=0.80\textwidth]{Imagenes/Capitulo2/ARM-Pipeline.eps}
...
\begin{figure}[h]
	\centering
		\includegraphics[width=0.75\textwidth]{Imagenes/Capitulo2/ArquitecturaFPGA.eps}
...
Debido a su naturaleza re-configurable, las FPGAs conllevan un mayor coste en área, retardos y consumo de energía: requieren un área 20 veces mayor, consume 10 veces más energía y trabaja 3 veces más lenta \cite {Kuon2007}. 

\begin{figure}
	\centering
		\includegraphics[width=0.65\textwidth]{Imagenes/Capitulo2/UsoFPGA.png}
	\caption{"`Distribución de las aplicaciones de las FPGAs en el año 2008."' \cite{Tecnologias}}
	\label{fig:UsoFPGA}
\end{figure}
...
\begin{figure}
	\centering
		\includegraphics[width=\textwidth]{Imagenes/Capitulo2/Nexys4-top-2000.eps}
